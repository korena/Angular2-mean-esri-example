define(["esri/arcgis/utils","esri/dijit/Search","esri/geometry/Point","esri/symbols/PictureMarkerSymbol","esri/layers/FeatureLayer","esri/InfoTemplate","esri/graphic","esri/SpatialReference","esri/geometry/webMercatorUtils"], function(__WEBPACK_EXTERNAL_MODULE_33__, __WEBPACK_EXTERNAL_MODULE_34__, __WEBPACK_EXTERNAL_MODULE_35__, __WEBPACK_EXTERNAL_MODULE_36__, __WEBPACK_EXTERNAL_MODULE_37__, __WEBPACK_EXTERNAL_MODULE_38__, __WEBPACK_EXTERNAL_MODULE_39__, __WEBPACK_EXTERNAL_MODULE_41__, __WEBPACK_EXTERNAL_MODULE_48__) { return webpackJsonp([0],[
/* 0 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search_component_1 = __webpack_require__(42);
	var app_component_1 = __webpack_require__(43);
	var create_donor_component_1 = __webpack_require__(44);
	var map_service_1 = __webpack_require__(32);
	var location_service_1 = __webpack_require__(40);
	var persistence_service_1 = __webpack_require__(46);
	    ...
	    AppModule = __decorate([
	        core_1.NgModule({
	            ...
	            declarations: [
	                ...
	                create_donor_component_1.DonorFormComponent
	            ],
	            providers: [
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map_service_1 = __webpack_require__(32);
	var location_service_1 = __webpack_require__(40);
	var SpatialReference = __webpack_require__(41);
	var Point = __webpack_require__(35);
	var FeatureLayer = __webpack_require__(37);
	var InfoTemplate = __webpack_require__(38);
	var MapComponent = (function () {
	    function MapComponent(elRef, _locationService, _mapService) {
	        this.elRef = elRef;
	        this._locationService = _locationService;
	        this._mapService = _mapService;
	        this.mapLoaded = new core_1.EventEmitter();
	        this.onLocationClicked = new core_1.EventEmitter();
	        this.onCreateFeature = new core_1.EventEmitter();
	        this.locationFocus = false;
	    }
	    MapComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        // get the device location 
	        this._locationService.getLocation(this.locationOptions).subscribe(function (position) {
	            _this.location = new Point(position.coords.longitude, position.coords.latitude);
	        }, function (error) {
	            console.log(error);
	        }, function () {
	        ...
	        this._mapService.createMap(this.itemId, this.elRef.nativeElement.firstChild, this.options).then(function (response) {
	            ...
	            template.setContent(_this.getTextContent);
	            template.setTitle("Donor Information");
	            _this.donorsLayer = new FeatureLayer("https://services.arcgis.com/GRMbfzH3YjODZfit/arcgis/rest/services/donors/FeatureServer/0", {
	                outFields: ["*"],
	                mode: FeatureLayer.MODE_SNAPSHOT,
	                infoTemplate: template
	            });
	            // set map feature layer
	            _this.map.addLayer(_this.donorsLayer);
	            // console.log('map:',this.map);
	            // register location click listener ... only after the layer is added 
	            _this.map.on('layer-add', function (evt) {
	                _this.map.graphics.on("click", function (event) {
	                    _this.locationClickHandler(event);
	                });
	            });
	    ...
	    MapComponent.prototype.locationClickHandler = function (event) {
	        this.onLocationClicked.emit(event);
	    };
	    MapComponent.prototype.createDonor = function (model) {
	        var _this = this;
	        var result;
	        this._mapService.createDonorFeature(model, this.donorsLayer, function (response) {
	            console.log(response);
	            _this.onCreateFeature.emit(response);
	        }, function (error) {
	            console.log(error);
	            _this.onCreateFeature.emit(null);
	        });
	    };
	    MapComponent.prototype.getTextContent = function (graphic) {
	    ...
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], MapComponent.prototype, "onLocationClicked", void 0);
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], MapComponent.prototype, "onCreateFeature", void 0);
	    MapComponent = __decorate([
	        ...
	        __metadata('design:paramtypes', [core_1.ElementRef, location_service_1.LocationService, map_service_1.MapService])
	    ], MapComponent);
	    return MapComponent;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(4);
	var arcgisUtils = __webpack_require__(33);
	var Search = __webpack_require__(34);
	var Point = __webpack_require__(35);
	var PictureMarkerSymbol = __webpack_require__(36);
	var FeatureLayer = __webpack_require__(37);
	var InfoTemplate = __webpack_require__(38);
	...
	var MapService = (function () {
	    ...
	    MapService.prototype.createMap = function (itemIdOrInfo, domNodeOrId, options) {
	        return arcgisUtils.createMap(itemIdOrInfo, domNodeOrId, options).then(function (response) {
	            ...
	            response.donorsLayer = new FeatureLayer("https://services.arcgis.com/GRMbfzH3YjODZfit/arcgis/rest/services/donors/FeatureServer", {
	    ...
	    MapService.prototype.placeMarker = function (map, point) {
	        var pointSymbol = new PictureMarkerSymbol("http://img3.wikia.nocookie.net/__cb20140427224234/caramelangel714/images/7/72/Location_Icon.png", 20, 30);
	        var pointInfoTemplate = new InfoTemplate("You Are Here");
	        var pointGraphic = new Graphic(point, pointSymbol, null, null);
	        map.graphics.add(pointGraphic);
	    };
	    MapService.prototype.createDonorFeature = function (model, layer, successCallback, errorCallback) {
	        ...
	        layer.applyEdits([newDonorGraphic], null, null, successCallback, errorCallback);
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationService = (function () {
	     ...
	     *   - enableHighAccuracy: Specify true to obtain the most accurate position possible, or false to optimize in favor of
	     ...
	     */
	    LocationService.prototype.getLocation = function (opts) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var search_component_1 = __webpack_require__(42);
	var create_donor_component_1 = __webpack_require__(44);
	var webMercatorUtils = __webpack_require__(48);
	var AppComponent = (function () {
	    function AppComponent() {
	        this.title = 'Bloodshare Map';
	        this.showMessage = true;
	        this.showLink = false;
	        this.link = '#';
	        this.messages = "You're looking at a map that displays information about registered blood donors,"
	            + "if you'd like to register, click on the icon showing your location, and provide the requested"
	            + " information.";
	        // map config
	        this.itemId = '53cf3182f9b24e178f16d708e4c6dc2c';
	        this.mapOptions = {
	            zoom: 5,
	    ...
	    AppComponent.prototype.onLocationClicked = function (event) {
	    ...
	    AppComponent.prototype.onFormSubmit = function (model) {
	    ...
	    AppComponent.prototype.onDonorFeatureCreate = function (response) {
	        if (response) {
	    ...
	    AppComponent.prototype.onDonorPersisted = function (url) {
	    ...
	    __decorate([
	        core_1.ViewChild(create_donor_component_1.DonorFormComponent), 
	        __metadata('design:type', create_donor_component_1.DonorFormComponent)
	    ], AppComponent.prototype, "donorFormComponent", void 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(4);
	var donor_model_1 = __webpack_require__(45);
	var persistence_service_1 = __webpack_require__(46);
	var DonorFormComponent = (function () {
	    function DonorFormComponent(_persistenceService) {
	        this._persistenceService = _persistenceService;
	        this.donorModel = new core_1.EventEmitter();
	        this.onDonorModelPersisted = new core_1.EventEmitter();
	        this.activated = false;
	        this.groups = ['A', 'A+',
	            'B', 'B+', 'AB', 'O'];
	    }
	    DonorFormComponent.prototype.onSubmit = function () {
	        // check duplicate email, this should have been done earlier :-)
	        this.getUser();
	    };
	    DonorFormComponent.prototype.fillInit = function (longitude, latitude) {
	        this.model = new donor_model_1.Donor('', '', '', '', 'A');
	        this.model.longitude = longitude;
	        this.model.latitude = latitude;
	    };
	    DonorFormComponent.prototype.getUser = function () {
	        var _this = this;
	        console.log('getting user', this.model);
	        this._persistenceService.getUser(this.model).subscribe(function (data) {
	            console.log('status:', data.status);
	            if (data.status === 200) {
	                // tell the user to try again ...
	                _this.donorModel.emit(null);
	                _this.clearForm();
	            }
	            else if (data.status === 204) {
	                console.log('model: ', _this.model);
	                _this.donorModel.emit(_this.model);
	            }
	        }, function (error) { return console.error(error); });
	    };
	    DonorFormComponent.prototype.persistDonor = function (objectId) {
	        var _this = this;
	        this.model.objectId = objectId;
	        var editLink = "/edit/" + this.model.first_name + "/" + this.model.last_name +
	            "/" + this.model.objectId;
	        this.model.creator_link = editLink;
	        this._persistenceService.addUser(this.model).subscribe(function (data) {
	            console.log('persistence status:', data.status);
	            _this.onDonorModelPersisted.emit(_this.model.creator_link);
	        }, function (error) { return console.error(error); }, function () {
	            _this.clearForm();
	        });
	    };
	    DonorFormComponent.prototype.clearForm = function () {
	        this.model = new donor_model_1.Donor('', '', '', '', 'A');
	    };
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], DonorFormComponent.prototype, "donorModel", void 0);
	    __decorate([
	        core_1.Output(), 
	        __metadata('design:type', Object)
	    ], DonorFormComponent.prototype, "onDonorModelPersisted", void 0);
	    DonorFormComponent = __decorate([
	        core_1.Component({
	            selector: 'donor-form',
	            template: __webpack_require__(47)
	        }), 
	        __metadata('design:paramtypes', [persistence_service_1.PersistenceService])
	    ], DonorFormComponent);
	    return DonorFormComponent;
	}());
	exports.DonorFormComponent = DonorFormComponent;
...
/***/ function(module, exports) {
	...
	"use strict";
	var Donor = (function () {
	    function Donor(first_name, last_name, contact_number, email_address, blood_group) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div   class=\"container\" style=\"width: 100%; \npadding: 0;\">\n    <div *ngIf=\"activated\">\n        <h4>New Donor Entry</h4>\n        <form (ngSubmit)=\"onSubmit()\" #donorForm=\"ngForm\"  >\n            <div class=\"form-group\">\n                <label for=\"first_name\">First Name</label>\n                <input type=\"text\" class=\"form-control\" id=\"first_name\" [(ngModel)]=\"model.first_name\" name=\"first_name\" required #first_name=\"ngModel\">\n                <div [hidden]=\"first_name.valid || first_name.pristine\" class=\"alert alert-danger\">\n                    First Name is required\n                </div>\n                <label for=\"last_name\">Last Name</label>\n                <input type=\"text\" class=\"form-control\" id=\"last_name\" [(ngModel)]=\"model.last_name\" name=\"last_name\" #last_name=\"ngModel\" required>\n                <div [hidden]=\"last_name.valid || last_name.pristine\" class=\"alert alert-danger\">\n                    Last Name is required\n                </div>\n            </div>\n            <div class=\"form-group\">\n                <label for=\"blood_group\">Blood Group</label>\n                <select class=\"form-control\" id=\"blood_group\" required [(ngModel)]=\"model.blood_group\" #blood_group=\"ngModel\" name=\"blood_group\">\n                    <option *ngFor=\"let group of groups\" [value]=\"group\">{{group}}</option>\n                </select>\n                <div [hidden]=\"blood_group.valid || blood_group.pristine\" class=\"alert alert-danger\">\n                    Blood Group is required\n                </div>\n            </div>\n            <div class=\"form-group\">\n                <label for=\"contact_number\">Contact Number</label>\n                <input type=\"text\" class=\"form-control\" id=\"contact_number\" [(ngModel)]=\"model.contact_number\" name=\"contact_number\" required #contact_number=\"ngModel\" placeholder=\"(xxxx-xxx-xxxx)\" pattern=\"^\\d{4}-\\d{3}-\\d{4}$\">\n                <div [hidden]=\"contact_number.valid || contact_number.pristine\" class=\"alert alert-danger\">\n                    Contact number is invalid\n                </div>\n                <label for=\"email_address\">Email Address</label>\n                <input type=\"text\" class=\"form-control\" id=\"email_address\" [(ngModel)]=\"model.email_address\" name=\"email_address\" #email_address=\"ngModel\" \n                pattern=\"^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$\">\n                <div [hidden]=\"email_address.valid || email_address.pristine\" class=\"alert alert-danger\">\n                    Email Address is invalid\n                </div>\n            </div>\n            <div class=\"form-group\">\n                <label for=\"longitude\">Longitude</label>\n                <input type=\"text\" class=\"form-control\" id=\"longitude\" [(ngModel)]=\"model.longitude\" name=\"longitude\" required readonly=\"true\">\n                <label for=\"latitude\">Latitude</label>\n                <input type=\"text\" class=\"form-control\" id=\"latitude\" [(ngModel)]=\"model.latitude\" name=\"latitude\" required readonly=\"true\">\n            </div>\n            <input type=\"submit\" class=\"btn btn-default\" [disabled]=\"!donorForm.form.valid\" value=\"Submit\" />\n            <button class=\"btn btn-default\" (click)=\"submitted=false\">Clear</button>\n        </form>\n    </div>\n</div>\n";
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"row\">\n    <div class=\"col-sm-8 col-md-9 col-lg-10 map-col\">\n        <esri-map [itemId]=\"itemId\" [options]=\"mapOptions\" [locationOptions]=\"locationOptions\" (mapLoaded)=\"onMapLoad($event)\" (onLocationClicked)=\"onLocationClicked($event)\" (onCreateFeature)=\"onDonorFeatureCreate($event)\">\n            <esri-search [options]=\"searchOptions\"></esri-search>\n        </esri-map>\n    </div>\n    <div class=\"col-sm-4 col-md-3 col-lg-2 form-col\">\n        <div [hidden]=\"!showMessage\">\n            <div class=\"alert\" style=\"overflow:hidden\">\n                <p style=\"text-align: center;\">{{messages}}</p>\n                <div style=\"word-break: break-all;\">\n                    <a [hidden]=\"!showLink\" href=\"{{link}}\">{{link}}</a>\n                </div>\n            </div>\n        </div>\n        <donor-form (donorModel)=\"onFormSubmit($event)\" (onDonorModelPersisted)=\"onDonorPersisted($event)\"></donor-form>\n    </div>\n</div>\n";
